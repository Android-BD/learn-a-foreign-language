...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Page3 = __webpack_require__(222);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { onEnter: isLoggedIn, path: 'dashboard', component: _Page4.default }),
	    '// ',
	    _react2.default.createElement(_reactRouter.Route, { path: 'dashboard', component: _Page2.default })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouteUtils = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormLogin = __webpack_require__(219);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(_FormLogin2.default, null);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputText = __webpack_require__(220);

	var _InputText2 = _interopRequireDefault(_InputText);

	var _ButtonSubmit = __webpack_require__(221);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'form',
	            { encType: 'application/json', className: 'loginForm', onSubmit: this.handleSubmit, method: 'POST' },
	            _react2.default.createElement(
	                'h2',
	                null,
	                'Login/Signup'
	            ),
	            _react2.default.createElement(_InputText2.default, { placeholder: 'Email address', type: 'email', name: 'email' }),
	            _react2.default.createElement(_InputText2.default, { placeholder: 'Password', type: 'password', name: 'password' }),
	            _react2.default.createElement(_ButtonSubmit2.default, { onClick: this.login, value: 'Login' }),
	            _react2.default.createElement('hr', null),
	            _react2.default.createElement(
	                'em',
	                null,
	                'If you don\'t have an account, just hit \'Sign up\'!'
	            ),
	            _react2.default.createElement('br', null),
	            _react2.default.createElement(_ButtonSubmit2.default, { onClick: this.signup, value: 'Sign up' })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement('input', { style: this.style, name: this.props.name, type: this.props.type, placeholder: this.props.placeholder, value: this.state.value, onChange: this.handleChange, required: true });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement("input", { type: "submit", value: this.state.value, onChange: this.handleChange, onClick: this.props.onClick });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormAddWord = __webpack_require__(223);

	var _FormAddWord2 = _interopRequireDefault(_FormAddWord);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(_FormAddWord2.default, null);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputWord = __webpack_require__(224);

	var _InputWord2 = _interopRequireDefault(_InputWord);

	var _ButtonAdd = __webpack_require__(231);

	var _ButtonAdd2 = _interopRequireDefault(_ButtonAdd);

	var _TextArea = __webpack_require__(232);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'form',
	            { encType: 'application/json', className: 'addWordForm', onSubmit: this.handleSubmit, method: 'POST', action: '/words' },
	            _react2.default.createElement(
	                'h2',
	                null,
	                'Add a word or expression'
	            ),
	            _react2.default.createElement(
	                'p',
	                null,
	                'Make sure it is not in the database, already'
	            ),
	            _react2.default.createElement(_InputWord2.default, { id: 'new_word', placeholder: 'New word or expression', onChange: this.changeWord }),
	            _react2.default.createElement(
	                'h3',
	                null,
	                'Add meanings (required)'
	            ),
	            _react2.default.createElement(
	                'h4',
	                null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutosuggest = __webpack_require__(225);
	...
	exports.default = _react2.default.createClass({
	    ...
	    makeSuggestion: function makeSuggestion(input, callback) {
	        ...
	        req.onreadystatechange = function () {
	            ...
	            var suggestions = JSON.parse(req.responseText).words.map(function (w) {
	                return w;
	            } /*.expression*/);
	    ...
	    renderSuggestion: function renderSuggestion(suggestion, input) {
	        // suggestion is a word that will be displayed below the input as a suggestion
	        var index = suggestion.expression.indexOf(input);
	        return _react2.default.createElement(
	            'span',
	            null,
	            suggestion.expression.slice(0, index),
	            _react2.default.createElement(
	                'strong',
	                null,
	                suggestion.expression.slice(index, index + input.length)
	            ),
	            suggestion.expression.slice(index + input.length)
	        );
	    },
	    getSuggestionValue: function getSuggestionValue(suggestionObj) {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(_reactAutosuggest2.default, { suggestions: this.makeSuggestion,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactThemeable = __webpack_require__(228);

	var _reactThemeable2 = _interopRequireDefault(_reactThemeable);

	var _sectionIterator = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(227);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectAssign = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    handleChange: function handleChange(event) {
	        var new_lines = event.target.value.split('\n');
	        console.log("change");
	    ...
	    render: function render() {
	        return _react2.default.createElement('textarea', { rows: '5', name: 'description', value: this.state.value, onChange: this.handleChange });
	    }
	});
